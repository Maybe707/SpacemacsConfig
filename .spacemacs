...
before packages are loaded."
  ...
  (setq-default dotspacemacs-configuration-layers
                '((c-c++ :variables c-c++-backend 'lsp-clangd)))
  (setq lsp-auto-guess-root t)   ;; For disable blacklisted files.
  (global-eldoc-mode -1)
